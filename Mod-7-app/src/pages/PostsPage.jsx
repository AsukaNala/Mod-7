...
export function Post() {
  const { id } = useParams(); // hook to access dynamic params
...
// ++ Change the ‘Load 10 Posts’ link to a drop-down allowing users to choose  5, 10 or 20 posts. Use the handleChangeLimit function in the onChange event.
